...
alter table xlsys_identity
   drop constraint FK_XLSYS_ID_REFERENCE_XLSYS_ME;
...
alter table xlsys_oacmbelong
   drop constraint FK_XLSYS_OA_REFERENCE_XLSYS_OA;
...
(
   searchtext         VARCHAR2(4000)       not null,
   heat               NUMBER(8,0)          not null,
...
alter table xlsys_identity
   add constraint FK_XLSYS_ID_REFERENCE_XLSYS_ME foreign key (welcomemenuid)
...
alter table xlsys_oacmbelong
   add constraint FK_XLSYS_OA_REFERENCE_XLSYS_OA foreign key (oamid)
